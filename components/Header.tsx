    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-black/20 backdrop-blur-xl supports-[backdrop-filter]:bg-black/20">
      <div className="flex h-16 items-center justify-between px-6 max-w-7xl mx-auto">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          ...
          <div className="h-6 w-6 rounded bg-linear-to-br from-blue-500 to-purple-600 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.6)] transition-shadow duration-300" />
          ...
          <SignedOut>
            <SignInButton mode="modal">
              ...
              <button className="relative overflow-hidden rounded-md bg-blue-600 px-5 py-2 text-sm font-medium text-white transition-all hover:bg-blue-500 hover:shadow-[0_0_20px_rgba(37,99,235,0.5)]">
                ...
                <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] hover:translate-x-[100%] transition-transform duration-500" />
              </button>
            </SignInButton>
          </SignedOut>
        </div>
