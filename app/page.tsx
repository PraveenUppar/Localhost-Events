  ...
  return (
    <div className="flex flex-col gap-8 pb-20">
      ...
      <section className="relative py-12 md:py-20 text-center">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-blue-500/20 blur-[100px] rounded-full -z-10" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {events.map((event) => {
          ...
          return (
            ...
            >
              {/* Card Container with Glass effect and Border Gradient */}
              <div className="h-full flex flex-col bg-slate-900/50 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:bg-slate-900/80 hover:border-blue-500/50 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)]">
                ...
                <div className="h-48 w-full bg-slate-800 relative overflow-hidden">
                  {/* Gradient overlay for text readability if you add real images later */}
